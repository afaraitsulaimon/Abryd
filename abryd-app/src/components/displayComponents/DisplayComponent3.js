...
const DisplayComponent3 = () => {
  ...
  return (
    ...
    <div className='containerDisplay3'>
        <Snowfall color='grey'/>
        <div style={{ display:"flex", justifyContent:'center'}}>
              ...
              <div className='innerContainer' style={{width:'80vw',height:'auto', border:'2px solid white', borderRadius:'20px', marginTop:'5vh', backgroundColor:'transparent'  }}>
                ...
                <TextInfo>
                  <div>
                  <p>One of the Best Procurement Services </p>
                  </div>
                ...
                <Boxes>
                   ...
                   style={{ backgroundColor:'rgba(119, 113,112,0.3)' }} >
                    ...
                    style={{ backgroundColor:'rgba(119, 113,112,0.8)', cursor:'pointer', display:'flex', justifyContent:'center', alignItems:'center' }}>
                        ...
                        <Link to={"/procurement-services"} style={{ textDecoration:'none', color:'white', textAlign:'center', fontSize:'1.5em', fontWeight:'bold' }}>Procurement <br/> Services</Link>
                    </motion.div>
...
export default DisplayComponent3